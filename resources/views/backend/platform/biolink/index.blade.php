        ...
        <div class="col-span-12">
            <div class="card dark:border-zinc-600 dark:bg-zinc-800">
                <div class="card-body flex items-center justify-between border-b border-gray-100 dark:border-zinc-600">
                    <h6 class="text-15 mb-1 text-gray-700 dark:text-gray-100">List Platform Biolink</h6>
                    @can('admin.create')
                        <button
                                    ...
                                    <div class="bg-white dark:bg-zinc-700">
                                        ...
                                        <div class="p-5">
                                            <h3 class="mb-4 text-xl font-medium text-gray-700 dark:text-gray-100">Add
                                                Platform</h3>
                                            <form class="space-y-4" action="{{ route('platform.biolink.store') }}"
                ...
                <div class="card-body relative overflow-x-auto">
                    <x-backend.table :datas="$platforms" :columns="['name', 'url', 'thumbnail']" name="roles">
                        @foreach ($platforms as $cell)
                            <tr>
                                ...
                                <x-backend.column-table>
                                    ...
                                    <x-backend.btn.action-delete name="platform.biolink" :id="$cell->id">
                                        delete
                                    </x-backend.btn.action-delete>
                                </x-backend.column-table>
                            </tr>
                            <x-backend.modal id="edit-modal-{{ $cell->id }}" title="Edit Platform">
                                <form class="space-y-4" action="{{ route('platform.biolink.update', $cell->id) }}"
