<x-backend.dashboard-layout>
                        ...
                        <div class="px-4 pt-5 pb-4 bg-white sm:p-6 sm:pb-4 dark:bg-zinc-700">
                            <div class="sm:flex sm:items-start">
                                ...
                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    <h3 class="text-lg font-medium leading-6 text-gray-900 dark:text-gray-100" id="modal-title">Deactivate presave</h3>
                                    <div class="mt-2">
                                        <p class="text-sm text-gray-500 dark:text-zinc-100/60">Are you sure you want to deactivate this presave?</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        function changeStats(id) {
            ...
            chgStats.action = '{{ route("platform.presave.status.update", ":id") }}'.replace(':id', id);
        }
