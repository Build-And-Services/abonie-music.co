                        ...
                        <div class="flex flex-wrap items-center">
                            ...
                            <div class="md:ml-3 mt-3 md:mt-0">
                                ...
                                <div class="flex flex-wrap items-start gap-2 text-13">
                                    <div class="capitalize text-gray-500 dark:text-zinc-100"><i class="text-green-500 align-middle mdi mdi-circle-medium me-1 ltr:mr-1 rtl:ml-1"></i>{{$getUser->getRoleNames()->first()}}</div>
