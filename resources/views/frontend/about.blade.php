<section id="about" class="section-active tab-area-five bgc-black text-white pt-120 rpt-100 pb-80 rpb-60 rel z-1">
    <div class="container">
        <div class="row gap-100 align-items-center justify-content-center">
            <div class="col-lg-6">
                <div class="tap-five-content rmb-55" data-aos="fade-left" data-aos-duration="1500" data-aos-offset="50">
                    ...
                    <ul class="nav advanced-tab style-four mb-40" role="tablist">
                        <li>
                            <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#tabFour1">Bio Link</button>
                        </li>
                        <li>
                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#tabFour2">Short Link</button>
                        </li>
                        <li>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="tabFour1">
                            <p><b>BIO LINK</b> <br> Sed ut perspiciatis unde omnis iste natus voluptatem accusantium doloremque laudantium totamto aperiame eaque ipsa quae ab illo inventore veritatis</p>
                        ...
                        <div class="tab-pane fade" id="tabFour2">
                            <p><b>SHORT LINK</b> <br> Sed ut perspiciatis unde omnis iste natus voluptatem accusantium doloremque laudantium totamto aperiame eaque ipsa quae ab illo inventore veritatis</p>
                            <div class="feature-icon-box text-white mt-30">
                                <div class="icon">
                                    <i class="far fa-check"></i>
                                </div>
                        ...
                        <div class="tab-pane fade" id="tabFour3">
                            <p><b>EASY TO USE</b> <br> Sed ut perspiciatis unde omnis iste natus voluptatem accusantium doloremque laudantium totamto aperiame eaque ipsa quae ab illo inventore veritatis</p>
                            <div class="feature-icon-box text-white mt-30">
                                <div class="icon">
                                    <i class="far fa-check"></i>
                                </div>
            ...
            <div class="col-lg-6">
                <div class="management-images mb-20" data-aos="fade-right" data-aos-duration="1500" data-aos-offset="50">
                    <img src="assets/office-abonie.png" alt="Management">
                    <div class="management-over">
                        <img src="assets/hero-5.png" alt="Management">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row pt-90 rpt-70 gap-10">
            <div class="col-lg-4 col-md-6">
                <div class="counter-item style-two counter-text-wrap" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="counter-item style-two counter-text-wrap" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1500" data-aos-offset="50">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="counter-item style-two counter-text-wrap" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1500" data-aos-offset="50">
