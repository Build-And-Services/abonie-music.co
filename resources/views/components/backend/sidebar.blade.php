        ...
        <div class="metismenu pb-10 pt-2.5" id="sidebar-menu">
            ...
            <ul id="side-menu">
                ...
                @can('admin.view')
                    ...
                    <li class="{{ request()->is('dashboard/users*') && !request()->is('dashboard/users/profile/*') ? 'mm-active' : '' }}">
                        <a href="javascript: void(0);" aria-expanded="{{ request()->is('dashboard/users*') && !request()->is('dashboard/users/profile/*') ? 'true' : 'false' }}" 
                            class="nav-menu block px-6 py-2.5 text-sm font-medium text-gray-950 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:hover:text-white dark:active:text-white">
